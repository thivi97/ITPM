      ...
      <ul>
        ...
        <li><a href="#">
          <span class="title">methods</span>
		   ...
		   <li><a href="http://localhost:8040/java123/Inhel.jsp" class="active">
...
<div style="margin-left:25%;padding:1px 16px;height:1000px;">
  ...
  <br>
   <div>
            ...
            <br>
           <form action="FileUploadHandlerIn" enctype="multipart/form-data" method="post">
        ...
        <br>
        <br>
  <form method="post" action="Inhel.jsp">
      <textarea name="tx" placeholder="Write something..fuck" style="height:200px">${requestScope["message"]}</textarea>
    </div>
...
<a href="resultIn.jsp"> <input name="btnSum2" type="Submit" value="next"></a>       
