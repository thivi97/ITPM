...
<body>
 ...
 <div class="sidebar">
      <ul>
        <li><a href="http://localhost:8040/java123/index.jsp" class="active">       
        ...
        <li><a href="#">
          <span class="title">methods</span>
		   ...
		   <li><a href="http://localhost:8040/java123/Inheritance.jsp">
...
<tr>
	...
	<% String text[] = session.getAttribute("tx").toString().split("\\n");
		for(String para : text){ %>
			<tr><td><%out.print(para);%> </td></tr>
	<% }
	%>
	</table>
